...
// DEVICE LOGS
export async function retrieveDeviceLogs(sessionId: string, buildId: string): Promise<string[]> {
...
// APPIUM LOGS
export async function retrieveAppiumLogs(sessionId: string, buildId: string): Promise<string[]> {
...
// CRASH LOGS
export async function retrieveCrashLogs(sessionId: string, buildId: string): Promise<string[]> {
