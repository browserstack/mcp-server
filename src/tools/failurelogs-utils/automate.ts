...
// SESSION LOGS
export async function retrieveSessionFailures(sessionId: string): Promise<string[]> {
...
// CONSOLE LOGS
export async function retrieveConsoleFailures(sessionId: string): Promise<string[]> {
