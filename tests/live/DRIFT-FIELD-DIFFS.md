...
## `bulk_edit_test_cases_v2`  _(observed on: preprod)_
**declared, never returned:**
- `success.async`
- `success.unique_id`
**returned, never declared:**
...
- `destination_path_folders[].group_id is a quoted STRING ("3452") in the live response; the declared schema types it as an integer. Every other id-shaped field on the same objects (id, project_id, parent_id) came back as a plain JSON integer, and no id/parent_id-as-string was reproduced here (matching the campaign's prior non-reproduction on create_sub_folder_v1) - the drift is narrowly on group_id.`
...
## `bulk_retrieve_test_cases`  _(observed on: preprod)_
**returned, never declared:**
...
## `clone_exploratory_session_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `clone_test_run`  _(observed on: preprod)_
**declared, never returned:**
...
## `close_test_run_v1`  _(observed on: preprod)_
**declared, never returned:**
- `observability_url`
- `self_ui_link`
- `type`
...
## `create_bulk_test_cases_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `create_custom_field_dataset_v2`  _(observed on: preprod)_
**declared, never returned:**
- `data.options — declared as an array of option objects (items: object); the create response returns it as an empty object {} instead, and does not echo the two options submitted in the request body at all. This is not a serializer bug: a follow-up get_custom_field_dataset_v2(dataset_id=31320, fetch_options=true) confirms both options were in fact created and stored (ids 146668/146669) — the create endpoint's response simply never reflects them, regardless of what was sent.`
**returned, never declared:**
- `data.created_at`
...
## `create_custom_field_definition_v2`  _(observed on: preprod)_
**declared, never returned:**
...
## `create_report`  _(observed on: preprod)_
**declared, never returned:**
- `data.mail_to`
**returned, never declared:**
- `data.grain`
...
## `create_root_folder_v1`  _(observed on: preprod)_
**declared, never returned:**
- `data.project.links`
...
## `create_shared_step_v1`  _(observed on: preprod)_
**returned, never declared:**
- `data.tags`

## `create_step_result_v1`  _(observed on: preprod)_
**declared, never returned:**
- `/configuration_id`
**returned, never declared:**
...
## `create_sub_folder_v1`  _(observed on: preprod)_
**returned, never declared:**
- `data.folder.attachments`
- `data.folder.created_by`
...
## `create_test_case_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `create_test_run_v1`  _(observed on: preprod)_
**declared, never returned:**
- `observability_url (never returned by create, though get_test_runs_v1 returns it for the identical run - create-serializer-specific gap)`
- `self_ui_link (never returned, also absent from get_test_runs_v1 for the same run)`
...
- `type (never returned, also absent from get_test_runs_v1 for the same run)`
**returned, never declared:**
- `attachments`
- `closed_at`
- `closed_by`
...
## `edit_test_case_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `get_custom_field_dataset_v2`  _(observed on: preprod)_
**returned, never declared:**
- `data.created_at`
- `data.custom_field_id`
...
## `get_custom_field_values_v1`  _(observed on: prod)_
**returned, never declared:**
...
## `get_entity_filter_details_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_folder_tree_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `group_id`
...
## `get_issues_count_info_v1`  _(observed on: prod)_
**declared, never returned:**
- `count`
- `label`

## `get_project_id_custom_fields_v2_v1`  _(observed on: preprod, prod)_
**returned, never declared:**
...
## `get_projects_basic_v1`  _(observed on: preprod)_
**declared, never returned:**
- `projects[].permissions`

## `get_projects_minify_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `permissions`
- `projects[].permissions`
**returned, never declared:**
...
## `get_report_section_v1`  _(observed on: preprod, prod)_
**returned, never declared:**
...
## `get_root_folders_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_case_by_integer_id_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_case_count_trend_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `data.Total.field`
...
## `get_test_case_histories_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_case_history_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `history.user.email`
...
## `get_test_cases_for_v1_test_run`  _(observed on: preprod, prod)_
**returned, never declared:**
- `assignee_imported`
- `automation_state`
- `dataset_values`
...
## `get_test_cases_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `comments_count`
...
## `get_test_plan_by_integer_id_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_plan_execution_trend_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_plan_test_runs_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_results_for_test_case`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_run_cases_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `all_test_cases`
**returned, never declared:**
- `assignee_imported`
...
## `get_test_runs_form_fields_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `get_test_runs_selection`  _(observed on: preprod, prod)_
**declared, never returned:**
- `test_cases[].assignee`
...
## `get_test_runs_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `list_folder_test_cases_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `list_projects_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
- `project_creator`
...
## `list_test_case_tags_v1`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `list_test_plans_v1`  _(observed on: preprod, prod)_
**returned, never declared:**
...
## `list_workspace_fields_v2`  _(observed on: preprod)_
**declared, never returned:**
...
## `move_folder_v1`  _(observed on: preprod)_
**declared, never returned:**
...
## `search_project_entities_v2`  _(observed on: preprod, prod)_
**declared, never returned:**
...
## `update_custom_field_dataset_project_mapping_v2`  _(observed on: preprod)_
**declared, never returned:**
- `data.options — declared type 'array' (items: object); every live response (all 4 calls) returned it as an OBJECT {data:[...3 rows...], info:{page,page_size,count,prev,next}}, never a bare array. Same drift previously confirmed on get_custom_field_dataset_v2's contract — this write endpoint's re-read has the identical shape bug.`
**returned, never declared:**
- `data.created_at`
- `data.custom_field_id`
- `data.datasetProjects — a second, differently-named copy of the exact same content as the declared data.linked_projects (confirmed identical project rows in both keys on every call in this probe, matching the parent create_custom_field_dataset_v2 probe's finding)`
...
## `update_custom_field_definition_v2`  _(observed on: preprod)_
**declared, never returned:**
- `default_value`
- `place_holder_text`
**returned, never declared:**
...
## `update_shared_step_v1`  _(observed on: preprod)_
**returned, never declared:**
...
## `update_test_plan_v1`  _(observed on: preprod)_
**declared, never returned:**
...
them. `rename_folder_v1`'s `group_id` is declared integer and returns the string `"3452"` — a
