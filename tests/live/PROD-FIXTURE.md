...
**`per_page` is ignored** on `get_root_folders_v1` here — asked for 3, got 30 with `page_size: 30`.
...
Use `TR-4827350` or `TR-3866741` instead — both found via `get_closed_test_runs`' progress
