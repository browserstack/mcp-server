...
### `get_test_case_by_integer_id_v1` — 46 undeclared
...
### `list_folder_test_cases_v1` — 29 undeclared
...
### `get_test_cases_v1` — 23 undeclared
- `automation_state`
- `estimated_duration_seconds`
- `is_shared`
- `review_status`
...
### `create_root_folder_v1` — 22 undeclared
...
### `get_test_runs_selection` — 20 undeclared
...
### `search_project_entities_v2` — 19 undeclared
...
### `get_test_cases_for_v1_test_run` — 15 undeclared
- `assignee_imported`
- `automation_state`
- `dataset_values`
- `deleted`
...
### `list_projects_v1` — 15 undeclared
- `duplicates_tc_count`
- `info.starred_count`
- `jira_mapped`
- `normalisedName`
...
### `get_test_plan_test_runs_v1` — 14 undeclared
...
### `get_system_field_values_v1` — 10 undeclared
...
### `bulk_edit_test_cases` — 10 undeclared
- `test_cases[].attachments`
- `test_cases[].estimated_duration_seconds`
- `test_cases[].is_shared`
- `test_cases[].step_count`
...
### `clone_exploratory_session_v1` — 10 undeclared
...
### `get_project_id_custom_fields_v2_v1` — 9 undeclared
...
### `get_entity_filter_details_v1` — 9 undeclared
...
### `create_step_result_v1` — 9 undeclared
...
### `edit_test_case_v1` — 9 undeclared
...
### `list_test_plans_v1` — 8 undeclared
...
### `update_custom_field_dataset_project_mapping_v2` — 8 undeclared
- `data.created_at`
...
### `get_custom_field_dataset_v2` — 8 undeclared
- `data.created_at`
- `data.custom_field_id`
...
### `get_test_runs_form_fields_v1` — 7 undeclared
...
### `create_bulk_test_cases_v1` — 7 undeclared
...
### `get_test_run_cases_v1` — 6 undeclared
- `assignee_imported`
...
### `create_custom_field_dataset_v2` — 6 undeclared
- `data.created_at`
- `data.custom_field_id`
...
### `create_test_case_v1` — 6 undeclared
- `folder.notes, path_folders[].notes/identifier/created_at/updated_at/deleted/parent_id/source/entity_type`
- `test_case.automation_state (full option object; automation_status is separately declared and also present)`
- `test_case.case_type.value_category / test_case.priority.value_category / test_case.status.value_category`
...
### `bulk_edit_test_cases_v2` — 5 undeclared
- `filter_details`
- `folders`
- `info`
- `test_cases`
...
### `create_test_run_v1` — 5 undeclared
- `attachments`
- `closed_at`
- `closed_by`
- `created_by`
...
### `update_custom_field_definition_v2` — 5 undeclared
- `group_id`
- `is_bulk_editable`
- `is_filterable`
...
### `create_custom_field_definition_v2` — 5 undeclared
- `data.group_id`
...
### `create_sub_folder_v1` — 5 undeclared
- `data.folder.attachments`
- `data.folder.created_by`
...
### `get_test_plan_by_integer_id_v1` — 4 undeclared
...
### `get_test_plan_execution_trend_v1` — 4 undeclared
...
### `update_shared_step_v1` — 3 undeclared
...
### `update_test_plan_v1` — 3 undeclared
- `test_plan.test_plan_progress`
- `test_plan.test_results_trend`
- `test_plan.test_results_trend_v2`

### `close_test_run_v1` — 3 undeclared
- `attachments`
- `created_by`
- `updated_by`

### `move_folder_v1` — 3 undeclared
...
### `get_test_case_histories_v1` — 2 undeclared
- `histories[].origin_channel`
- `origin_channel`

### `get_test_case_history_v1` — 2 undeclared
...
### `get_root_folders_v1` — 2 undeclared
- `folders[].notes`
...
### `get_report_section_v1` — 2 undeclared
...
### `get_custom_field_values_v1` — 1 undeclared
...
### `create_shared_step_v1` — 1 undeclared
- `data.tags`

### `list_workspace_fields_v2` — 1 undeclared
...
### `bulk_retrieve_test_cases` — 1 undeclared
