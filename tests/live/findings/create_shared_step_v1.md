# create_shared_step_v1 — DRIFT

- **Product / entity:** tm / `shared_step` (write, v1)
- **Environment:** preprod
- **Probed:** 2026-09-21, project PR-2005 (379335744)
- **Run file:** `tests/live/runs/tm/create_shared_step_v1.json`
