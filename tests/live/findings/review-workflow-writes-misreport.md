...
- **Product:** tm · **Capabilities:** `submit_test_cases_for_review_v1`, `apply_test_case_review_verdict_v1`
...
## 1. `submit_test_cases_for_review_v1` — `reviewers` is accepted, echoed, and discarded
...
## 2. `apply_test_case_review_verdict_v1` — `success: true` for a verdict that never lands
