...
- **Product:** tm · **Capabilities:** `edit_test_case_v1`, `edit_test_case_partial_v1`, and the bulk edits
...
`get_system_field_values_v1` with `field_name=status`. Two things about that response are worth
