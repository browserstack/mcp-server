...
| `list_test_run_test_cases_by_integer_id` | `318612` |
| `list_test_results_for_test_case_by_integer_id` | **`318639`** |
...
reported `318610` from the write response and from `list_test_run_test_cases_by_integer_id`, while
`list_test_results_for_test_case_by_integer_id` reported `318637` for the identical row. And a result created
...
`tests/live/runs/tm/bulk_edit_test_cases_in_test_run.json`, `create_step_result.json`, and
